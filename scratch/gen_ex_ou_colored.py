...
CONFIG_CODE = code(
    ...
    "    fundamental={'mu': 1.0, 'eps': 0.02, 'D': 1.0, 'tauc': 0.5},",
...
SIM_CODE = code(
    ...
    "fp = res['_resolved']['fundamental']      # same physics as the theory run",
    ...
    "    tau_sim, C_r = compute_kpoint_slice(",
    ...
    "        voltage_bins=x_bins)                             # connected slice",
    "    C_runs.append(np.asarray(C_r).real)",
    ...
    "      % (C0_tree, C0_loop, C_sim[js], C_err[js]))",
