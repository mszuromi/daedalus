...
\newtcolorbox{gotcha}[1][]{colback=warnbg,colframe=warnframe,
  fonttitle=\bfseries,title={Gotcha},sharp corners,boxrule=0.6pt,#1}
...
\input{sections/00-how-to-read.tex}
...
\input{sections/02-quickstart.tex}

% =====================================================================
%  PART II  --  SPECIFYING A MODEL
% =====================================================================
\part{Specifying a Model}
\input{sections/03-theory-spec.tex}
\input{sections/04-theory-files.tex}
\input{sections/05-colored-markovian.tex}

% =====================================================================
%  PART III  --  BUILDING THE PERTURBATION THEORY
% =====================================================================
\part{Building the Perturbation Theory}
\input{sections/06-fieldtheory-core.tex}
\input{sections/07-propagator.tex}
\input{sections/08-mean-field.tex}
\input{sections/09-enumeration.tex}
\input{sections/10-type-assignment.tex}
\input{sections/11-caching.tex}

% =====================================================================
%  PART IV  --  EVALUATING DIAGRAMS : TEMPORAL
% =====================================================================
\part{Evaluating Diagrams: Temporal Models}
\input{sections/12-phasej-temporal.tex}
\input{sections/13-grouped-phasej.tex}

% =====================================================================
%  PART V  --  EVALUATING DIAGRAMS : SPATIAL
% =====================================================================
\part{Evaluating Diagrams: Spatial Models}
\input{sections/14-spatial-core.tex}
\input{sections/15-spatial-heatkernel.tex}
\input{sections/16-spatial-coupled.tex}

% =====================================================================
%  PART VI  --  ASSEMBLY & THE USER SURFACE
% =====================================================================
\part{Assembly and the User Surface}
\input{sections/17-compute-orchestration.tex}
\input{sections/18-engine-api.tex}
\input{sections/19-cumulants-moments.tex}
\input{sections/20-simulators.tex}
\input{sections/21-ui.tex}
...
\appendix
\part{Appendices}
\input{sections/A-glossary.tex}
\input{sections/B-external-tools.tex}
\input{sections/C-file-index.tex}
\input{sections/D-known-issues.tex}
