...
the spatial v2 operator-IR test model.
...
first-class backend-C test model for derivative / form-factor vertices.
"""
...
def build():
    return (
        SpatialModelBuilder('1D conserved reaction-diffusion (derivative vertex)',
                      n_populations=0)
