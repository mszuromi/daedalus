"""
Single population Cubic Alpha Test — text-driven theory file.
...
def build():
    return (
        TemporalTheoryBuilder('Single population Cubic Alpha Test')
    ...
    [0.2, 0.3],
        ...
        .define_function('phi', args=['v'], expression='a[i]*v^3', population='E')
        .define_kernel('g', time_expr='(t/taug[i,j]^2)*exp(-t/taug[i,j])*heaviside(t)', latex_name='g', indexed_by=['E', 'E'])
        .set_action_text('''
            sum( nt[i]*n[i] 
